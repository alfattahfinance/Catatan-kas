...
function applyLogo(){const logo=getLogo();document.querySelectorAll(".app-logo,.ck-logo,.logo,.logo-preview,#logo,#logoDashboard,#dashboardLogo,#laporanLogo,#logoPreview,#logoPreviewV2,#previewLogoDashboard,img[alt='Logo Dashboard'],img[alt='Logo aplikasi'],img[alt='Photoroom_20260812_224807'],[data-dashboard-logo]").forEach(png=>{if(!png||png.tagName!=="IMG")return;if(png.dataset.logoSyncApplied===logo)return;png.dataset.logoSyncApplied=logo;png.removeAttribute("srcset");png.removeAttribute("data-src");png.src=logo;png.onerror=function(){if(png.dataset.logoFallback==="1")return;png.dataset.logoFallback="1";png.src=FALLBACK_LOGO}})}
