...
setPersistence(auth,browserLocalPersistence).catch(e=>console.warn("Firebase Auth persistence:",e));
(function(){try{if(!document.querySelector('link[data-global-theme="true"]')){const link=document.createElement("link");link.rel="stylesheet";link.href="css/theme.css?v=20260823";link.dataset.globalTheme="true";document.head.appendChild(link)}}catch(e){console.warn("Tema global gagal dimuat:",e)}})();
